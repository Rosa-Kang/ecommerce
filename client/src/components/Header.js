          ...
          >
            ...
            <div className="nav">
              <ul className="nav__list">
                <li>
                  <a href="#home" style={{ color: this.state.color }}>
                    Home
                  </a>
                </li>
                <li className="nav__list--shop">
                  <a
                    href="javascript:void(0)"
                    className="btn"
                    style={{ color: this.state.color }}
                  >
                    Shop <div className={this.state.class} />
                  </a>
                  <div className="nav__list--shop--dropDown">
                    <div
                      id="menu"
                      className="nav__list--shop--dropDown--picture"
                    >
                    ...
                    <div
                      id="menu"
                      className="nav__list--shop--dropDown--earings"
                    >
                      <h3>Earings</h3>
                      <h5>All Earings</h5>
                      <h5>Gold</h5>
                    ...
                    <div
                      id="menu"
                      className="nav__list--shop--dropDown--necklaces"
                    >
                      <h3>Necklaces</h3>
                      <h5>All Necklaces</h5>
                      <h5>Gold</h5>
                    ...
                    <div id="menu" className="nav__list--shop--dropDown--rings">
                      <h3>Rings</h3>
                      <h5>All Rings</h5>
                      <h5>Gold</h5>
                      <h5>Silver</h5>
